"""
Preprocess i3fresh data for UniSRec next-item prediction
...
- i3fresh.valid.inter
- i3fresh.test.inter
- i3fresh.feat1CLS (BERT embeddings)
"""
...
def main():
    parser = argparse.ArgumentParser(description='Preprocess i3fresh data for UniSRec with different tag files')
    ...
    if args.dataset_name is None or args.output_dir is None:
        ...
        if args.dataset_name is None:
            args.dataset_name = f'i3fresh_{tag_suffix}'
        if args.output_dir is None:
            args.output_dir = f'data/unisrec/{args.dataset_name}'

    print("="*80)
    print("PREPROCESSING I3FRESH DATA FOR UNISREC")
    print("="*80)
