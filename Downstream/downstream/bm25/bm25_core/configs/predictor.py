...
import os
import abc
from typing import Literal, Mapping, Annotated, Optional, Union
...
class BM25RecPredictorConfig(BasePredictorConfig):
    ...
    document_corpus_config: Optional[CorpusConfig] = Field(None)
...
PredictorConfigT = Annotated[Union[BM25RecPredictorConfig,
                             BM25IRPredictorConfig,
