...
def pid_seqs_to_iid_seqs(
    seqs: Union[list[list[int]], list[int]], all_pids: list[int]
):
    ...
    Args:
        seqs (Union[list[list[int]], list[int]]): sequence of sequences
        all_pids (Optional[list[int]], optional): All product ids.
    """
