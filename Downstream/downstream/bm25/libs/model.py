...
class GPT4RecommendationBaseModel(nn.Module):
    ...
    def __init__(self, config, qwen_model):
        ...
        # IMPORTANT: Resize embeddings if necessary and then sync the vocab size
        # This is the single source of truth for vocab size after potential resizing.
        qwen_model.resize_token_embeddings(self.vocab_size)
        self.vocab_size = qwen_model.get_input_embeddings().num_embeddings
        ...
        print(f"   Model embedding size: {self.vocab_size}")
