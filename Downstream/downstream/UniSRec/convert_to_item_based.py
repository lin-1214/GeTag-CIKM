...
def convert_to_item_based(dataset_path):
    ...
    Args:
        dataset_path: Path to the dataset directory (e.g., 'data/preprocessed/UniSRec/food_native')
    """
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, required=True,
                        help='Path to dataset directory (e.g., data/preprocessed/UniSRec/food_native)')
